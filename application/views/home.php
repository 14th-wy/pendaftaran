	...
	<div class="row">
	    ...
	    <div class="col-sm" style="margin-top: 50px">
			...
			<a href="<?php echo base_url(). 'jurusan'; ?>" type="button" class="btn btn-primary btn-block shadow p-3 d-flex justify-content-center" style="height: 200px; background-color: #e17055; border: none;">
				<p class="" style="font-size: 50px; padding: 10%;">Jurusan baru</p>
			</a>
	    ...
	    <div class="col-sm" style="margin-top: 50px">
			...
			<button type="button" class="btn btn-primary btn-block shadow p-3" style="height: 200px; background-color: #fdcb6e; border: none;">
				<p style="font-size: 50px">Jurusan</p>
			</button>
