<?php
    ...
    <tr>
        ...
        <td align="center" width="80%">LAPORAN SISWA<br>
    ...
    <table style="border-collapse: collapse; padding: 10px;" >
        <tr>
            ...
            <th style="border: 1px solid #292828">No. Pembayaran</th>
            <th style="border: 1px solid #292828">Kode Siswa</th>
            <th style="border: 1px solid #292828">Nama Siswa</th>
        ...
        foreach($data as $u){ 
            ...
            <tr>
                ...
                <td style="border: 1px solid #292828">'.$u->NO_PEMBAYARAN.'</td>
                <td style="border: 1px solid #292828">'.$u->KODE_SISWA.'</td>
                <td style="border: 1px solid #292828">'.$u->NAMA_SISWA.'</td>
