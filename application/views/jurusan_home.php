	...
	<form target="_blank" method="GET" action="<?php echo base_url(). 'formpendaftaran/report'; ?>">
		...
		<div class="row" style="margin-top: 10px">
			...
			<div class="col-2" style="margin: 0; max-width: 160px;">
				...
				<a type="button" href="<?php echo base_url(). 'jurusan/laporan'; ?>" class="btn btn-primary">Laporan</a>
			</div>
				<!-- 
		        ...
		        <tbody>
					...
					?>
			            ...
			            <tr>
			                ...
			                <td>
			                	<a href="<?php echo base_url(). 'jurusan/?kodeProgram='.$u->kode_jurusan; ?>" class="btn btn-link">Ubah</a>
			                	<button onclick="confirmDelete('<?=$u->kode_jurusan?>')" class="btn btn-link" data-toggle="modal" data-target="#staticBackdrop">Hapus</button>
			                </td>
			            </tr>
		      		...
		      		<div class="row">
		      			...
		      			<div class="col-sm">
			      			...
			      			<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="kode_jurusan" name="kode_jurusan" value="<?=$data[0]->kode_jurusan?>">
							</div>
							...
							<div class="form-group">
							    ...
							    <select class="form-control" id="nama_jurusan" name="nama_jurusan">
							      ...
							      <option value="">Pilih Nama Jurusan</option>
													<option value="Teknik Instalasi Pemasangan Tenaga Listrik">Teknik Instalasi Pemasangan Tenaga Listrik</option>
