<div class="container-fluid">
	...
	<?php
		...
		if($this->input->get('noPembayaran') != ""){
			...
			$choosejurusan = $this->MFormPendaftaran->getFindSiswa( $data[0]->NAMA_CALON_SISWA );
			...
			// $data[0]->BENDAHARA = $this->session->username;

			// var_dump( base_url().'public/'.$data[0]->BUKTI_TF ); exit;
		}else{
			$data[0]->id = "";
		      		...
		      		<div class="row">
						  ...
						  <input type="hidden" name="modeEdit" value="<?=$this->input->get('noPembayaran')?>">
							...
							<div class="form-group">
								...
								<img src="<?=base_url().'public/'.$data[0]->BUKTI_TF?>" alt="bukti pembayaran">
							</div>
		      			...
		      			<div class="col-sm">
			      			...
			      			<div class="form-group">
							    ...
							    <input readonly="" type="text" class="form-control" id="NO_PEMBAYARAN" name="NO_PEMBAYARAN" value="<?=$data[0]->NO_PEMBAYARAN?>">
							</div>
							...
							<div class="form-group">
							    ...
							    <select class="form-control" id="JURUSAN" name="JURUSAN">
							      ...
							      <option value="">Pilih Jurusan</option>
									...
									<option value="Teknik Permesinan" <?php if($choosejurusan[0]->JURUSAN == "Teknik Permesinan"){ echo "selected"; } ?> >Teknik Permesinan</option>
									<option value="Teknik instalasi tenaga listrik" <?php if($choosejurusan[0]->JURUSAN == "Teknik instalasi tenaga listrik"){ echo "selected"; } ?>>Teknik instalasi tenaga listrik</option>
									<option value="Teknik kendaraan ringan" <?php if($choosejurusan[0]->JURUSAN == "Teknik kendaraan ringan"){ echo "selected"; } ?>>Teknik kendaraan ringan</option>
									<option value="Administrasi perkantoran" <?php if($choosejurusan[0]->JURUSAN == "Administrasi perkantoran"){ echo "selected"; } ?>>Administrasi perkantoran</option>
									<option value="Akuntansi" <?php if($choosejurusan[0]->JURUSAN == "Akuntansi"){ echo "selected"; } ?>>Akuntansi</option>
							    </select>
						    </div>
							...
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="BENDAHARA" name="BENDAHARA" value="<?=$this->session->nama?>">
							</div>
