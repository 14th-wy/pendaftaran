		      		...
		      		<div class="row">
		      			...
		      			<div class="col-sm">
			      			...
			      			<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="noPendaftaran" name="noPendaftaran" value="<?=$data[0]->NO_PENDAFTARAN?>">
							</div>
							...
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="jenisKelamin" name="jenisKelamin" value="<?=$data[0]->JENIS_KELAMIN?>">
							</div>
							...
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="agama" name="agama" value="<?=$data[0]->AGAMA?>">
							</div>
